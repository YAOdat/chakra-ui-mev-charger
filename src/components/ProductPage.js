...
export default function Simple() {
  ...
  // Define state for selected color
      ...
      >
        <Flex>
          <TransformWrapper>
            <TransformComponent>
              <img
                src={selectedColor?.imageUrl || product?.imageUrl} // Use product's imageUrl if there are no color options
                alt="product image"
              ...
              <Stack spacing={3} direction="row" align="center">
                {product.color.map((color) => (
                  <Button
                    ...
                    py={'6'}
                    bg={
                      color === selectedColor ? 'green.500' : 'gray.200'
                    }
                    color={
                      color === selectedColor ? 'white' : 'gray.500'
                    }
